        ...
        <div class="box" align="center">
            ...
            <div class="input">
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <input  type="text" name="kategory" menu="id" required> <br>
                    <label  for=""><br>Rak         :<br> </label>
                    <input  type="number" name="rak" menu="exp" required> <br>
                    <label  for=""><br>penulis       :<br> </label>
                    <input  type="text" menu="exp" name="penulis" required> <br>
                    <div class="submit">
...
if(isset($_POST['submit'])){
    ...
    if(move_uploaded_file($tmp,"gambar/".$gambar_baru)){
        $query = "INSERT INTO buku (judul, namagambar, gambar, kategory,rak,penulis) 
        VALUES ('$judul','$namagambar','$gambar_baru','$kategory','$rak','$penulis')";

...
<head>
    ...
    <title>ADMIN</title>
    <link href="admin.css?v2" rel="stylesheet">
    <!-- Favicons -->
  ...
  <ul class="d-flex align-items-center">
    ...
    <li class="nav-item d-block d-lg-none">
      ...
      <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
        <img src="https://icons.veryicon.com/png/o/miscellaneous/matripe/admin-8.png" alt="Profile" class="rounded-circle">
...
<ul class="sidebar-nav" id="sidebar-nav" align="center">
      ...
      <div class="row">
        ...
        <div class="col-xxl-4 col-md-6">
          <div class="card info-card sales-card">
            ...
            <div class="card-body">
              <h5 class="card-title">USER-in <span>| Today</span></h5>
        ...
        <div class="col-xxl-4 col-md-6">
          <div class="card info-card revenue-card">
            ...
            <div class="card-body">
              <h5 class="card-title">Buku yang dipinjam <span>| This Month</span></h5>
